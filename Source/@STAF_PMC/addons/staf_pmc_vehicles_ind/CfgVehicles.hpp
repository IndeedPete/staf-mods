...
class CfgVehicles {
    ...
    class STAF_caiman_woodland_ind : rhsusf_M1220_M2_usarmy_wd {
    ...
    class STAF_caiman_desert_ind : rhsusf_M1220_M2_usarmy_d {
    ...
    class STAF_husky_woodland_ind : burnes_husky_W {
    ...
    class STAF_husky_desert_ind : burnes_husky {
