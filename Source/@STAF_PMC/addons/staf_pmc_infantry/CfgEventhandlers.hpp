class Extended_Init_EventHandlers {
  ...
  class STAF_contractor_medic {
    class STAF_contractor_medic_init_eh {
      init = "(_this select 0) setvariable [""ace_isMedic"", 2]; (_this select 0) setUnitTrait [""Medic"", true]; [(_this select 0)] execVM '\staf_pmc_main\scripts\random_uniform.sqf';";
    };
  };
  ...
  class STAF_contractor_engineer {
    class STAF_contractor_engineer_init_eh {
      init = "(_this select 0) setvariable [""ace_isEOD"", 1]; (_this select 0) setvariable [""ACE_isEngineer"", 2]; (_this select 0) setUnitTrait [""Engineer"", true]; [(_this select 0)] execVM '\staf_pmc_main\scripts\random_uniform.sqf';";
    };
  };
