...
for "_i" from 1 to 5 do {_unit addMagazine "SmokeShell";};
for "_i" from 1 to 3 do {_unit addMagazine "SmokeShellGreen";};
for "_i" from 1 to 2 do {_unit addMagazine "SmokeShellRed";};
