class CfgWeapons {
  ...
  class STAF_V_PlateCarrierL_Pete_Arid: V_PlateCarrierH_CTRG
  {
  	...
  	hiddenSelectionsTextures[] = {"\staf_pmc_vests\staf\addons\staf_pmc_vests\txt\vests_pete_Arid_co.paa"};
  ...
  class STAF_V_PlateCarrierL_Pete_Lush: STAF_V_PlateCarrierL_Pete_Arid
  {
  	...
  	hiddenSelectionsTextures[] = {"\staf_pmc_vests\staf\addons\staf_pmc_vests\txt\vests_pete_lush_co.paa"};
  ...
  class STAF_V_PlateCarrierL_Pete_Winter: STAF_V_PlateCarrierL_Pete_Arid
  {
  	...
  	hiddenSelectionsTextures[] = {"\staf_pmc_vests\staf\addons\staf_pmc_vests\txt\vests_pete_Winter_co.paa"};
  ...
  class STAF_V_PlateCarrier2_Stroke_khk: IP_V_PlateCarrier2_khkEF
  {
  	...
  	hiddenSelectionsTextures[] = {"\staf_pmc_vests\staf\addons\staf_pmc_vests\txt\vests_stroke_khk_co.paa"};
  };
};
