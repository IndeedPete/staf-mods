...
_infectionrater = missionnamespace setVariable ["STAF_Horror_InfectionRate", _infectionrate];
...
while {alive _unit && (_unit getVariable "STAF_Horror_Infected")} do {
  _infection = _unit getVariable ["STAF_Horror_Infection", 0];
  _infectionrate = missionnamespace getVariable ["STAF_Horror_InfectionRate", 0.005];
