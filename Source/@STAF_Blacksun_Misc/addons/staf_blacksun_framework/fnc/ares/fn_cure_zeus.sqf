["STAF Horror", "(Infection) Cure Unit",
{
	...
	{
    _infection = _x getVariable ["STAF_Horror_Infection", 0];
    _infectionrate = missionnamespace getVariable ["STAF_Horror_InfectionRate", 0.05];

		_x setVariable ["STAF_Horror_Infected",false];
	  _x setVariable ["STAF_Horror_Immunity",false];
