		...
		class AttributeCategories
		{
			...
			class STAF_Attributes
			{
				...
				class Attributes
				{
					...
					class STAF_att_disable_LAMBS
					{
						//--- Mandatory properties
						displayName = "Disable LAMBS"; // Name assigned to UI control class Title
						tooltip = "Disables LAMBS Danger on the unit"; // Tooltip assigned to UI control class Title
						property = "STAF_att_disable_LAMBS_true"; // Unique config property name saved in SQM
						control = "Checkbox"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
						...
						// %s is replaced by attribute config name. It can be used only once in the expression
						// In MP scenario, the expression is called only on server.
						expression = "_this setVariable ['lambs_danger_disableAI', false, true]";
					...
					class STAF_att_disable_VCOM
					{
						//--- Mandatory properties
						displayName = "Disable VCOM"; // Name assigned to UI control class Title
						tooltip = "Disables VCOM Danger on the unit"; // Tooltip assigned to UI control class Title
						property = "STAF_att_disable_VCOM_true"; // Unique config property name saved in SQM
						control = "Checkbox"; // UI control base class displayed in Edit Attributes window, points to Cfg3DEN >> Attributes
						...
						// %s is replaced by attribute config name. It can be used only once in the expression
						// In MP scenario, the expression is called only on server.
						expression = "_this setVariable ['Vcm_Disable', true, true]";
