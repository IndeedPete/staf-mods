_EarsZeus = [
  ...
  {((_player getVariable ["STAF_var_ZeusActionEligible", false]) or (serverCommandAvailable "#logout")) && (!(_player getvariable ["TFAR_CuratorCamEars", true])) && (_player getVariable ["STAF_var_ZeusAction", false])}
