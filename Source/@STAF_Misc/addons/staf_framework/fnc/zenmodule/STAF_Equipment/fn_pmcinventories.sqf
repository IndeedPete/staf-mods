	  ...
	  ],
	  {
    	...
    	_dialogValues params ["_inventoryType"];
			...
			_switch = switch _inventoryType do {
				case "_car": {[_objectUnderCursor] call STAF_fnc_carequipment};
				case "_MRAP": {[_objectUnderCursor] call STAF_fnc_mrapequipment};
				case "_apc": {[_objectUnderCursor] call STAF_fnc_apcequipment};
				case "_truck": {[_objectUnderCursor] call STAF_fnc_mrapequipment};
				case "_smallHeli": {[_objectUnderCursor] call STAF_fnc_helismallequipment};
				case "_bigHeli": {[_objectUnderCursor] call STAF_fnc_helibigequipment};
				case "_boat": {[_objectUnderCursor] call STAF_fnc_boatequipment};
				case "_ammoDrone": {[_objectUnderCursor] call STAF_fnc_droneammoequipment};
				case "_medicalDrone": {[_objectUnderCursor] call STAF_fnc_dronemedicequipment};
				case "_expDrone": {[_objectUnderCursor] call STAF_fnc_droneexplosionequipment};
			};
		},
	  {},
		_objectUnderCursor
