...
_objs addMagazineCargoGlobal ["hlc_30rnd_556x45_SOST_G36",14]; //G36
_objs addMagazineCargoGlobal ["hlc_30Rnd_9x19_B_MP5",8]; //MP5
_objs addMagazineCargoGlobal ["ACE_20Rnd_762x51_M118LR_Mag",6]; //M14
_objs addMagazineCargoGlobal ["200Rnd_556x45_Box_F",8]; //M249
_objs addMagazineCargoGlobal ["150Rnd_762x54_Box",8]; //Negev
_objs addMagazineCargoGlobal ["ACE_30Rnd_556x45_Stanag_Mk318_mag",14]; //SCAR
_objs addMagazineCargoGlobal ["30Rnd_762x39_Mag_F",14]; //AK12
_objs addMagazineCargoGlobal ["20Rnd_762x51_Mag",6]; //SIG
