...
#include "fn_ww2usArsenal_backpacks.sqf"
#include "fn_ww2usArsenal_headgear.sqf"
#include "fn_ww2usArsenal_items.sqf"
#include "fn_ww2usArsenal_othermagazines.sqf"
#include "fn_ww2usArsenal_uniforms.sqf"
#include "fn_ww2usArsenal_vests.sqf"
#include "fn_ww2usArsenal_weapons.sqf"
...
[
  [_box],
  {
    ...
    _box setVariable ["STAF_var_ww2usarsenal_actionId", _actionId, true];
  }
] remoteExec ["spawn", 0, true];

_box setVariable ["STAF_var_ww2usarsenal", true, true];