["STAF WW2", "Arsenal",
{
  ...
  switch (_dialogResult select 0) do {
    case 0: {{[_x] call STAF_WW2_fnc_ww2gerarsenal;} forEach _selectedObjects;};
    case 1: {{[_x] call STAF_WW2_fnc_ww2sovarsenal;} forEach _selectedObjects;};
    case 2: {{[_x] call STAF_WW2_fnc_ww2ukarsenal;} forEach _selectedObjects;};
    case 3: {{[_x] call STAF_WW2_fnc_ww2usaarsenal;} forEach _selectedObjects;};
    case 4: {{[_x] call STAF_WW2_fnc_ww2japarsenal;} forEach _selectedObjects;};
  };
