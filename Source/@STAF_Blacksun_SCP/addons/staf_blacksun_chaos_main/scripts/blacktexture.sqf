...
_MRAP = ["STAF_Blacksun_Chaos_MRAP_Armed","STAF_Blacksun_Chaos_MRAP","STAF_Blacksun_Chaos_MRAP_Armed_opf","STAF_Blacksun_Chaos_MRAP_opf","STAF_Blacksun_Chaos_MRAP_Armed_ind","STAF_Blacksun_Chaos_MRAP_ind"];
