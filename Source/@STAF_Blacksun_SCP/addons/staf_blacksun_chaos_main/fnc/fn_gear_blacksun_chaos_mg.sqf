...
_weapon = ["STAF_arifle_CTARS_blk"] call BIS_fnc_selectRandom;
...
//Ammo
if (_weapon == "STAF_arifle_CTARS_blk") then {
  for "_i" from 1 to 5 do {_unit addItem "100Rnd_580x42_Mag_Tracer_F";};
};
