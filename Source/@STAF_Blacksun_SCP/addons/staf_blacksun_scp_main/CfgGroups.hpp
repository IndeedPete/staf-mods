class CfgGroups {
    class WEST {
        class STAF_Blacksun_SCP {
            ...
            class SpecOps {
                name = "Special Forces (Mobile Task Force)";
                class STAF_Blacksun_SCP_CBBRN_Fire_Team {
                    name = "CBRN Fire Team";
                    side = 1;
                    faction = "STAF_blacksun_scp";
                    icon = "\A3\ui_f\data\map\markers\nato\b_inf.paa";
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 1;
                        vehicle = "STAF_Blacksun_MTF_CBRN";
                    };
                    class Unit1 {
                        position[] = { 5 , -5 , 0 };
                        rank = "PRIVATE";
    ...
    class EAST {
        class STAF_Blacksun_SCP_opf {
            ...
            class SpecOps {
                name = "Special Forces (Mobile Task Force)";
                class STAF_Blacksun_SCP_CBBRN_Fire_Team_opf {
                    name = "CBRN Fire Team";
                    side = 0;
                    faction = "STAF_blacksun_scp_opf";
                    icon = "\A3\ui_f\data\map\markers\nato\b_inf.paa";
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "STAF_Blacksun_MTF_CBRN_opf";
                    };
                    class Unit1 {
                        position[] = { 5 , -5 , 0 };
                        rank = "PRIVATE";
    ...
    class INDEP {
        class STAF_Blacksun_SCP_ind {
            ...
            class SpecOps {
                name = "Special Forces (Mobile Task Force)";
                class STAF_Blacksun_SCP_CBBRN_Fire_Team_ind {
                    name = "CBRN Fire Team";
                    side = 0;
                    faction = "STAF_blacksun_scp_ind";
                    icon = "\A3\ui_f\data\map\markers\nato\b_inf.paa";
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "STAF_Blacksun_MTF_CBRN_ind";
                    };
                    class Unit1 {
                        position[] = { 5 , -5 , 0 };
                        rank = "PRIVATE";
